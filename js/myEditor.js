...
myEdToolBarCode1 =         
            '<input id="myEdBold" type="button" value="B" style="font-weight: bold;" >'+
            '<input id="myEdItalic" type="button" value="I" style="font-style: italic;">'+
            '<input id="myEdUnderline" type="button"  value="U" style="text-decoration: underline;" >'+
            '<input id="myEdLink" type="button"  value="L" style="text-decoration: underline;" >'+
            '<input id="myEdTable" type="button"  value="T" >'+
            '<input id="myEdForeCol" class="colorControl" value="FC" type="button" style="background-color: rgb(0,0,0);color: white">'+
            '<input id="myEdBackCol" class="colorControl" value="BC" type="button">';
myEdToolBarCode2=
            '<input id="myEdUL" type="button" value="UL">'+
            '<input id="myEdOL" type="button" value="OL">'+
            '<input id="myEdrtl" type="button" value="<">'+
            '<input id="myEdltr" type="button" value=">">' +           
            '<input id="myEdWhole" type="button" value="All">'+ 
            '<input id="myEdExtra" type="button" value="..">'+ 
            '<input id="myEdFullScreen" type="button" value="F">'+
            '<input id="myEdClear" type="button" value="C">';
myEdToolBarCode3='<input id="myEdEn2Fa" type="button" value="E2F">'+
            '<input id="myEdFa2En" type="button"  value="F2E">';
